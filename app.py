...
def metrics():
    ...
    metrics_text = """# HELP aemo-v5_requests_total Total number of requests
# TYPE aemo-v5_requests_total counter
aemo-v5_requests_total {request_count}

# HELP aemo-v4_response_time_seconds Average response time
# TYPE aemo-v5_response_time_seconds gauge
aemo-v5_response_time_seconds {avg_response_time:.3f}

# HELP demo-v53_active_connections Current active connections
# TYPE aemo-v5_active_connections gauge
aemo-v5_active_connections {active_connections}

# HELP demo-v53_memory_usage_bytes Memory usage in bytes
# TYPE aemo-v5_memory_usage_bytes gauge
